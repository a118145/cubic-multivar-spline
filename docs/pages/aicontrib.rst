...
Some of the code in this library is partly or fully written by AI. The Claude chatbot (Sonnet 4.6) from Antropic was used. The following list provides an overview of the files or parts thereof that were created or significantly modified by AI:
